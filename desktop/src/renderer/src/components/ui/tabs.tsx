...
/** A quiet underline rail, not a pill group — the tabs shouldn't compete with the queue. */
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      'eyebrow relative -mb-px border-b-2 border-transparent pb-2 pt-1 transition-colors',
