  ...
  <DialogPrimitive.Portal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'rounded-[var(--radius-card)] border border-border bg-surface shadow-2xl shadow-black/25',
        'data-[state=open]:animate-in data-[state=closed]:animate-out',
        'data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
    ...
    >
      ...
      <DialogPrimitive.Close
        className={cn(
          'absolute right-3 top-3 rounded-[6px] p-1.5 text-fg-muted transition-colors',
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn('font-display text-[17px] font-semibold tracking-tight text-fg', className)}
    {...props}
  />
))
